...
namespace MarginTradingTests
{
    ...
    public class QuoteCashServiceTests : BaseTests
    {
        ...
        public void Is_GetQuoteRateForBaseAsset_Correct()
        {
            ...
            var quoteRate = _cfdCalculatorService.GetQuoteRateForBaseAsset(Accounts[0].BaseAssetId, instrument, "entity");
        ...
        public void Is_GetQuoteRateForQuoteAsset_Correct()
        {
            ...
            var quoteRate = _cfdCalculatorService.GetQuoteRateForQuoteAsset(Accounts[0].BaseAssetId, instrument, "entity");
        ...
        public void Is_Volume_In_Accont_Asset_Correct()
        {
            ...
            var accountVolume = _cfdCalculatorService.GetVolumeInAccountAsset(OrderDirection.Buy, Accounts[0].BaseAssetId, "BTCCHF", 1, "entity");
            Assert.AreEqual(1046.804, Math.Round(accountVolume, 3));

            accountVolume = _cfdCalculatorService.GetVolumeInAccountAsset(OrderDirection.Sell, Accounts[0].BaseAssetId, "BTCCHF", 1, "entity");
            Assert.AreEqual(1046.784, Math.Round(accountVolume, 3));

            accountVolume = _cfdCalculatorService.GetVolumeInAccountAsset(OrderDirection.Buy, Accounts[0].BaseAssetId, "BTCUSD", 1, "entity");
            Assert.AreEqual(1041.41, Math.Round(accountVolume, 3));

            accountVolume = _cfdCalculatorService.GetVolumeInAccountAsset(OrderDirection.Sell, Accounts[0].BaseAssetId, "BTCUSD", 1, "entity");
