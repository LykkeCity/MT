...
//                    return false;
                ...
                order.Execute(matchedOrders.WeightedAveragePrice, _dateService.Now(), externalOrderId,
                    externalProviderId);
...
//        }
        ...
        public Task<Order> ClosePositionAsync(string positionId, OrderCloseReason reason, string comment = null)
        {
