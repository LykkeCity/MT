    ...
    public static class DomainToBackendContractMapper
    {
        ...
        public static AccountHistoryBackendContract ToBackendContract(this IMarginTradingAccountHistory src)
        {
            return new AccountHistoryBackendContract
            {
                ...
                WithdrawTransferLimit = src.WithdrawTransferLimit,
                Comment = src.Comment,
                Type = src.Type.ToType<Contracts.Account.AccountHistoryTypeContract>(),
                OrderId = src.OrderId,
        ...
        public static OrderHistoryBackendContract ToBackendHistoryContract(this IOrder src)
        {
            return new OrderHistoryBackendContract
            {
                ...
                Type = src.GetOrderType().ToType<Contracts.Account.OrderDirectionContract>(),
                Status = src.Status.ToType<Contracts.Account.OrderStatusContract>(),
                CloseReason = src.CloseReason.ToType<Contracts.Account.OrderCloseReasonContract>(),
        ...
        public static OrderHistoryBackendContract ToBackendHistoryContract(this IOrderHistory src)
        {
            return new OrderHistoryBackendContract
            {
                ...
                Instrument = src.Instrument,
                AssetAccuracy = src.AssetAccuracy,
                Type = src.Type.ToType<Contracts.Account.OrderDirectionContract>(),
                Status = src.Status.ToType<Contracts.Account.OrderStatusContract>(),
                CloseReason = src.CloseReason.ToType<Contracts.Account.OrderCloseReasonContract>(),
                OpenDate = src.OpenDate,
                CloseDate = src.CloseDate,
        ...
        public static OrderHistoryBackendContract ToBackendHistoryOpenedContract(this IOrderHistory src)
        {
            return new OrderHistoryBackendContract
            {
                ...
                AssetAccuracy = src.AssetAccuracy,
                Type = src.Type.ToType<Contracts.Account.OrderDirectionContract>(),
                Status = OrderStatus.Active.ToType<Contracts.Account.OrderStatusContract>(),
                CloseReason = src.CloseReason.ToType<Contracts.Account.OrderCloseReasonContract>(),
                OpenDate = src.OpenDate,
                CloseDate = null,
                OpenPrice = src.OpenPrice,
        ...
        public static OrderBackendContract ToBackendContract(this IOrder src)
        {
            return new OrderBackendContract
            {
                ...
                AccountId = src.AccountId,
                Instrument = src.Instrument,
                Type = src.GetOrderType().ToType<Contract.BackendContracts.OrderDirectionContract>(),
                Status = src.Status.ToType<Contract.BackendContracts.OrderStatusContract>(),
                CloseReason = src.CloseReason.ToType<Contract.BackendContracts.OrderCloseReasonContract>(),
