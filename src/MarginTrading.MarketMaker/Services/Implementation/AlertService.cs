...
namespace MarginTrading.MarketMaker.Services.Implementation
{
	public class AlertService : IAlertService
	{
		...
		{
		    AlertStopOrAllowNewTrades(assetPairId, reason, true);
		}

		public void AlertAllowNewTrades(string assetPairId, string reason)
		{
		    AlertStopOrAllowNewTrades(assetPairId, reason, false);
		}

	    private void AlertStopOrAllowNewTrades(string assetPairId, string reason, bool stop)
	    {
