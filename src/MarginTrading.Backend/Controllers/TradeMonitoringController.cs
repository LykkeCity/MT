...
//            var orders = _ordersCache.GetAllOrders();
//
...
//        {
//            return _ordersCache.GetPositions().Where(order => order.GetMatchedVolume() >= volume).Select(Convert).ToList();
//        }
//
//        /// <summary>
//        ///     Returns list of opened positions from a snapshot (blob)
...
//        {
//            return _ordersCache.GetPositions().Where(order => order.OpenDate >= from.Date && order.OpenDate < to.Date)
...
//        {
//            return _ordersCache.GetPositions().Where(order => accountIds.Contains(order.AccountId)).Select(Convert)
//                .ToList();
//        }
//
//        /// <summary>
